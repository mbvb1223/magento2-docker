...
require INTEGRATION_TESTS_DIR . '/testsuite/Magento/Company/_files/company_with_structure.php';
require INTEGRATION_TESTS_DIR . '/testsuite/Magento/ConfigurableProduct/_files/product_configurable.php';
