...
class CustomerGridCollectionTest extends AbstractController
{
     ...
     * When I filter by a Sales Representative's username
     * Then the associated Company Admin customer will appear
     * When I filter by a nonexistent Sales Representative's username
     ...
     * When I sort the collection by Sales Representative username
     * Then the associated customer results will be sorted by Sales Representative username alphabetically
     *
     ...
     * When I filter by a Company Name
     * Then the associated Company Admin customer will appear
     * When I filter by partial Company Name
     * Then the associated Company Admin customer will still appear
     * When I filter by a nonexistent Company Name
     * Then an empty result set is returned
     *
