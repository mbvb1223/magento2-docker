...
class CreateTest extends AbstractController
{
     ...
     */
    public function testWebsiteRestrictionClosed(): void
    {
        $this->addUser();
     ...
     */
    public function testWebsiteRestrictionLoginOnly(): void
    {
        $this->addUser();
        $this->assertEquals(200, $this->getResponse()->getHttpResponseCode());
        $this->assertStringContainsString(self::CUSTOMER_SUCCESSFULLY_CREATED_MESSAGE, $this->getResponse()->getBody());
     ...
     */
    public function testWebsiteRestrictionLoginAndRegisterOnly(): void
    {
        $this->addUser();
        $this->assertEquals(200, $this->getResponse()->getHttpResponseCode());
        $this->assertStringContainsString(self::CUSTOMER_SUCCESSFULLY_CREATED_MESSAGE, $this->getResponse()->getBody());
