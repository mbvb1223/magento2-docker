...
class OrderDateToTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Test that applying a order date 'to' filter returns the expected orders from the search results.
     *
     ...
     * @throws \Exception
     */
    public function testApplyFilter($orderDateTo, $expectedOrderIds)
    {
    ...
    /**
     * Test that the date supplied to the orderDateTo filter is correctly parsed for the en_US locale - MM/DD/YYY
     *
     * @magentoConfigFixture default_store general/locale/code en_US
     * @magentoConfigFixture default_store general/locale/timezone UTC
     */
    ...
    /**
     * Test that the date supplied to the orderDateTo filter is correctly parsed for the en_GB locale - DD/MM/YYYY
     *
    ...
    /**
     * Test that the date supplied to the orderDateTo filter is correctly parsed for the zh_Hans locale - YYYY-MM-DD
     *
