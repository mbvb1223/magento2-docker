...
class PurchaseOrderPaymentInformationManagementTest extends WebapiAbstract
{
    ...
    const SERVICE_NAME = 'purchaseOrderPurchaseOrderPaymentInformationManagementV1';
    const RESOURCE_PATH = '/V1/carts/mine/po-payment-information';
     ...
     */
    public function testSuccessfulPlacementWithCompanyAdmin()
    {
     ...
     * @return array
     */
    private function getRequestData(CartInterface $quote)
    {
        return [
            'cart_id' => $quote->getId(),
